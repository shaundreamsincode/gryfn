    ...
    describe "test case 1" do
      it "creates the correct phonetic questions" do
        ...
        _speech_questions_level_3 = [
          create(:intake_speech_question, assessment: assessment, index: 10, correct_answer: 'above', level: 3),
          create(:intake_speech_question, assessment: assessment, index: 11, correct_answer: 'what', level: 3),
          create(:intake_speech_question, assessment: assessment, index: 12, correct_answer: 'any', level: 3),
          create(:intake_speech_question, assessment: assessment, index: 13, correct_answer: 'busy', level: 3),
          create(:intake_speech_question, assessment: assessment, index: 14, correct_answer: 'night', level: 3)
        ]
        ...
        expect(phonetic_questions.sort_by(&:index).pluck(:correct_answer)).to eq(%w(girl they above what any))
      end
    end
  end
end
