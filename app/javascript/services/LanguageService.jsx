    ...
    static _locales() {
        return {
            ...
            es: {
                ...
                chatInstructions: 'Describa sus síntomas a DocBot. Al final de su chat, haga clic en "finaliza" y se generará un resumen de su conversación. Puede enviar esta información a su médico para que la revise.',
                patient: 'PACIENTE',
                doctor: 'MEDICO',
                chatTextboxPlaceholder: 'Escribe algo',
                loading: 'Cargando',
                summaryGenerated: 'Resumen Generado',
                generateSummary: 'Genera Resumen',
                summaryCopied: '¡Resumen Copiado al Portapapeles!',
                // buttons
                sendButton: 'Envia',
                finishButton: 'Finaliza',
                homeButton: 'Hogar',
                copySummaryButton: 'Copia Resumen',
