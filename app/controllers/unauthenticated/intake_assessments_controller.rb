class Unauthenticated::IntakeAssessmentsController < Unauthenticated::UnauthenticatedController
  def show
  ...
  def move_speech_assessment_to_next_level
    intake_assessment = IntakeAssessment.find_by_token!(params[:intake_assessment_token])
    result = IntakeAssessments::Speech::MoveToNextLevel.call(assessment: intake_assessment)
